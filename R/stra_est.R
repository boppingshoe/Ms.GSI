...
#' }
#'
stratified_estimator_msgsi <- function(mdl_out = NULL, path = NULL, mixvec, new_pop_info = NULL, new_pop_by = "repunit") {
  ...
  #                   harvest = stats::rlnorm(max(itr)*max(ch),
...
utils::globalVariables(c("new_repunit", "mix", "sstc"))
