...
We also documented in details on the mathematical model of multistage framework and instructions for using *Ms.GSI* package. Once you installed *Ms.GSI*, you can call the document using `vignette("msgsi_vignette")`.
